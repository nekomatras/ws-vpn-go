...
type Config struct {
	...
	RemoteAddress    string `json:"remote_address"     env:"REMOTE_ADDRESS"     default:"https://127.0.0.1:443"` //Client
	...
	ListenAddress    string `json:"listen_address"     env:"LISTEN_ADDRESS"     default:"0.0.0.0:443"`           //Server
	...
	TunnelPath       string `json:"tunnel_path"        env:"TUNNEL_PATH"        default:"/ws"`                   //Common
	...
	MTU                uint `json:"mtu"                env:"MTU"                default:"1450"`                  //Server
